.class public final Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;
...
.field private volatile e:Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$LoggingConfiguration;
...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->DEFAULT_SYNC_MIN_GZIP_BYTES:J
    ...
    sput-object v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->a:[Ljava/lang/String;

    new-instance v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$1;

    invoke-direct {v0}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$1;-><init>()V

    sput-object v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->b:Lorg/apache/http/HttpRequestInterceptor;
...
.method private constructor <init>(Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/params/HttpParams;)V
    ...
    iput-object v0, p0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->d:Ljava/lang/RuntimeException;

    new-instance v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$2;

    invoke-direct {v0, p0, p1, p2}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$2;-><init>(Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/params/HttpParams;)V

    iput-object v0, p0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->c:Lorg/apache/http/client/HttpClient;
...
.method private static a(Lorg/apache/http/client/methods/HttpUriRequest;)Z
    ...
    sget-object v7, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->a:[Ljava/lang/String;
...
.method static synthetic access$000()Lorg/apache/http/HttpRequestInterceptor;
    ...
    sget-object v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->b:Lorg/apache/http/HttpRequestInterceptor;

    return-object v0
.end method

.method static synthetic access$300(Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;)Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$LoggingConfiguration;
    .locals 1

    iget-object v0, p0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->e:Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$LoggingConfiguration;
...
.method static synthetic access$500(Lorg/apache/http/client/methods/HttpUriRequest;Z)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Z
...
.method public static getCompressedEntity([BLandroid/content/ContentResolver;)Lorg/apache/http/entity/AbstractHttpEntity;
    ...
    invoke-static {p1}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->getMinGzipSize(Landroid/content/ContentResolver;)J
...
.method public static getMinGzipSize(Landroid/content/ContentResolver;)J
    ...
    sget-wide v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->DEFAULT_SYNC_MIN_GZIP_BYTES:J
...
.method public static newInstance(Ljava/lang/String;)Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, v0}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->newInstance(Ljava/lang/String;Landroid/content/Context;)Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;
...
.method public static newInstance(Ljava/lang/String;Landroid/content/Context;)Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;
    .locals 8
    ...
    new-instance v2, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;

    invoke-direct {v2, v0, v1}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;-><init>(Lorg/apache/http/conn/ClientConnectionManager;Lorg/apache/http/params/HttpParams;)V
...
.method public static parseDate(Ljava/lang/String;)J
    ...
    invoke-static {p0}, Lcom/alipay/mobile/common/transport/http/legacy/HttpDateTime;->parse(Ljava/lang/String;)J
...
.method public final close()V
    ...
    iget-object v0, p0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->d:Ljava/lang/RuntimeException;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->getConnectionManager()Lorg/apache/http/conn/ClientConnectionManager;
...
.method public final disableCurlLogging()V
    ...
    iput-object v0, p0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->e:Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$LoggingConfiguration;
...
.method public final enableCurlLogging(Ljava/lang/String;I)V
    ...
    :cond_2
    new-instance v0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$LoggingConfiguration;

    const/4 v1, 0x0

    invoke-direct {v0, p1, p2, v1}, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$LoggingConfiguration;-><init>(Ljava/lang/String;ILcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient$1;)V
...
.method public final execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/client/ResponseHandler;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/alipay/mobile/common/transport/http/legacy/AndroidHttpClient;->c:Lorg/apache/http/client/HttpClient;
