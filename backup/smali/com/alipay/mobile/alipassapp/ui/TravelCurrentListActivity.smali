.class public Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;
...
.method static synthetic a(Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;)Lcom/alipay/mobile/framework/app/ActivityApplication;
    .locals 1

    iget-object v0, p0, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->mApp:Lcom/alipay/mobile/framework/app/ActivityApplication;
...
.method protected final a(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    const-string/jumbo v6, "20000021"

    const-string/jumbo v7, ""

    const-string/jumbo v8, "travelItineraryDetails"

    const-string/jumbo v9, "myTravelList"

    const-string/jumbo v10, "seeTravelItinerary"
...
.method protected final a(Lcom/alipay/mobile/alipassapp/biz/model/a;)V
    ...
    sget v0, Lcom/alipay/mobile/alipassapp/R$string;->alipass_travel_nonetwork_toast:I

    invoke-virtual {p0, v0}, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->a(I)V
...
.method protected final b()Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->g:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->g:Landroid/view/View;
    ...
    new-instance v1, Lcom/alipay/mobile/alipassapp/ui/fh;

    invoke-direct {v1, p0}, Lcom/alipay/mobile/alipassapp/ui/fh;-><init>(Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;)V

    invoke-virtual {v0, v1}, Lcom/alipay/mobile/commonui/widget/APButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p0}, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Lcom/alipay/mobile/alipassapp/R$string;->alipass_goto_travel_web:I
...
.method protected final k()V
    ...
    iget-object v1, p0, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->a:Lcom/alipay/mobile/commonui/widget/APTitleBar;
    ...
    iget-object v0, p0, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->b:Lcom/alipay/mobile/commonui/widget/APPullRefreshView;

    invoke-virtual {v0, v3}, Lcom/alipay/mobile/commonui/widget/APPullRefreshView;->setEnablePull(Z)V

    iget-object v0, p0, Lcom/alipay/mobile/alipassapp/ui/TravelCurrentListActivity;->c:Lcom/alipay/mobile/alipassapp/ui/bb;
