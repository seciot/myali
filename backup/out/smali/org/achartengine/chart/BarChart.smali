...
.method private a(Landroid/graphics/Canvas;FFFFIILandroid/graphics/Paint;)V
    ...
    invoke-virtual {v2}, Lorg/achartengine/renderer/SimpleSeriesRenderer;->isGradientEnabled()Z
    ...
    invoke-virtual {v2}, Lorg/achartengine/renderer/SimpleSeriesRenderer;->getGradientStopValue()D
    ...
    invoke-virtual {v0, v3, v1}, Lorg/achartengine/chart/BarChart;->toScreenPoint([DI)[D
    ...
    invoke-virtual {v2}, Lorg/achartengine/renderer/SimpleSeriesRenderer;->getGradientStartValue()D
    ...
    invoke-virtual {v2}, Lorg/achartengine/renderer/SimpleSeriesRenderer;->getGradientStopColor()I

    move-result v10

    invoke-virtual {v2}, Lorg/achartengine/renderer/SimpleSeriesRenderer;->getGradientStartColor()I

    move-result v8

    cmpg-float v2, p5, v11
...
.method protected clickableAreasForPoints(Ljava/util/List;Ljava/util/List;FII)[Lorg/achartengine/chart/ClickableArea;
    ...
    new-array v9, v0, [Lorg/achartengine/chart/ClickableArea;

    invoke-virtual {p0, p1, v8, v7}, Lorg/achartengine/chart/BarChart;->getHalfDiffX(Ljava/util/List;II)F
...
.method protected drawBar(Landroid/graphics/Canvas;FFFFFIILandroid/graphics/Paint;)V
    ...
    invoke-direct/range {v1 .. v9}, Lorg/achartengine/chart/BarChart;->a(Landroid/graphics/Canvas;FFFFIILandroid/graphics/Paint;)V
...
.method protected drawChartValuesText(Landroid/graphics/Canvas;Lorg/achartengine/model/XYSeries;Lorg/achartengine/renderer/XYSeriesRenderer;Landroid/graphics/Paint;Ljava/util/List;II)V
    ...
    invoke-virtual {p0, v0, v10, v9}, Lorg/achartengine/chart/BarChart;->getHalfDiffX(Ljava/util/List;II)F
    ...
    invoke-virtual {p0, v1, v2, v3}, Lorg/achartengine/chart/BarChart;->getLabel(Ljava/text/NumberFormat;D)Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lorg/achartengine/renderer/XYSeriesRenderer;->getChartValuesTextSize()F
