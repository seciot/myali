...
.method public static encode(Ljava/lang/String;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;Ljava/util/Hashtable;Lcom/google/zxing/qrcode/encoder/QRCode;)V
    ...
    invoke-virtual {p3, v2}, Lcom/google/zxing/qrcode/encoder/QRCode;->setMode(Lcom/google/zxing/qrcode/decoder/Mode;)V
    ...
    invoke-virtual {p3, v1}, Lcom/google/zxing/qrcode/encoder/QRCode;->setVersion(I)V

    invoke-virtual {p3, v6}, Lcom/google/zxing/qrcode/encoder/QRCode;->setNumTotalBytes(I)V

    invoke-virtual {p3, v9}, Lcom/google/zxing/qrcode/encoder/QRCode;->setNumDataBytes(I)V

    invoke-virtual {p3, v7}, Lcom/google/zxing/qrcode/encoder/QRCode;->setNumRSBlocks(I)V

    invoke-virtual {p3, v8}, Lcom/google/zxing/qrcode/encoder/QRCode;->setNumECBytes(I)V

    invoke-virtual {v5}, Lcom/google/zxing/qrcode/decoder/Version;->getDimensionForVersion()I

    move-result v1

    invoke-virtual {p3, v1}, Lcom/google/zxing/qrcode/encoder/QRCode;->setMatrixWidth(I)V
    ...
    invoke-virtual {v0}, Lcom/google/zxing/common/ECI;->getValue()I

    move-result v0

    invoke-virtual {v1, v0, v11}, Lcom/google/zxing/common/BitArray;->appendBits(II)V
    ...
    invoke-static {v0, v4, v2, v1}, Lcom/google/zxing/qrcode/encoder/Encoder;->appendLengthInfo(IILcom/google/zxing/qrcode/decoder/Mode;Lcom/google/zxing/common/BitArray;)V
    ...
    invoke-static {v1, v0, v2, v3, v4}, Lcom/google/zxing/qrcode/encoder/Encoder;->interleaveWithECBytes(Lcom/google/zxing/common/BitArray;IIILcom/google/zxing/common/BitArray;)V
    ...
    invoke-direct {v5, v0, v1}, Lcom/google/zxing/qrcode/encoder/ByteMatrix;-><init>(II)V
    ...
    invoke-static {v4, v6, v7, v1, v5}, Lcom/google/zxing/qrcode/encoder/MatrixUtil;->buildMatrix(Lcom/google/zxing/common/BitArray;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;IILcom/google/zxing/qrcode/encoder/ByteMatrix;)V

    invoke-static {v5}, Lcom/google/zxing/qrcode/encoder/MaskUtil;->applyMaskPenaltyRule1(Lcom/google/zxing/qrcode/encoder/ByteMatrix;)I

    move-result v2

    add-int/lit8 v2, v2, 0x0

    invoke-static {v5}, Lcom/google/zxing/qrcode/encoder/MaskUtil;->applyMaskPenaltyRule2(Lcom/google/zxing/qrcode/encoder/ByteMatrix;)I

    move-result v8

    add-int/2addr v2, v8

    invoke-static {v5}, Lcom/google/zxing/qrcode/encoder/MaskUtil;->applyMaskPenaltyRule3(Lcom/google/zxing/qrcode/encoder/ByteMatrix;)I

    move-result v8

    add-int/2addr v2, v8

    invoke-static {v5}, Lcom/google/zxing/qrcode/encoder/MaskUtil;->applyMaskPenaltyRule4(Lcom/google/zxing/qrcode/encoder/ByteMatrix;)I
    ...
    const-string/jumbo v1, "Cannot find proper rs block info (input data too big?)"
    ...
    invoke-static {v4, v0, v1, v2, v5}, Lcom/google/zxing/qrcode/encoder/MatrixUtil;->buildMatrix(Lcom/google/zxing/common/BitArray;Lcom/google/zxing/qrcode/decoder/ErrorCorrectionLevel;IILcom/google/zxing/qrcode/encoder/ByteMatrix;)V
    ...
    const-string/jumbo v2, "Invalid QR code: "
