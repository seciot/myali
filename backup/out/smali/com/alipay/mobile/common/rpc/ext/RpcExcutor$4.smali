...
.field final synthetic val$warningTipStr:Ljava/lang/String;
...
.method constructor <init>(Lcom/alipay/mobile/common/rpc/ext/RpcExcutor;Ljava/lang/String;Landroid/view/View$OnClickListener;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4;->val$warningTipStr:Ljava/lang/String;

    iput-object p3, p0, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4;->val$clickAction:Landroid/view/View$OnClickListener;

    iput-object p4, p0, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4;->val$actionText:Ljava/lang/String;
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4;->val$warningTipStr:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/alipay/mobile/commonui/widget/APFlowTipView;->setTips(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4;->val$clickAction:Landroid/view/View$OnClickListener;
    ...
    iget-object v1, p0, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4;->val$actionText:Ljava/lang/String;

    new-instance v2, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4$1;

    invoke-direct {v2, p0}, Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4$1;-><init>(Lcom/alipay/mobile/common/rpc/ext/RpcExcutor$4;)V
