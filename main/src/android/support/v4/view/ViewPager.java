...
public class ViewPager extends ViewGroup
{
  ...
  public boolean arrowScroll(int paramInt)
  {
    ...
    label256: label312: label352: label358: label363: for (int n = 1; ; n = 0)
    {
      if (n == 0)
      {
  ...
  void populate(int paramInt)
  {
    ...
    if (this.mCurItem != paramInt)
      ...
      {
        i13 = 66;
        ViewPager.ItemInfo localItemInfo12 = infoForPosition(this.mCurItem);
        this.mCurItem = paramInt;
        localItemInfo1 = localItemInfo12;
        i = i13;
      }
    while (true)
    {
      ...
      while (true)
      {
        ...
        for (ViewPager.ItemInfo localItemInfo3 = addNewItem(this.mCurItem, i1); ; localItemInfo3 = localItemInfo2)
        {
          ...
          Object localObject2;
          label667: int i12;
          label690: ViewPager.ItemInfo localItemInfo11;
          ...
          if (localItemInfo3 != null)
          {
            ...
            if (i6 >= 0)
            {
              ...
              float f1 = 2.0F - localItemInfo3.widthFactor + getPaddingLeft() / getClientWidth();
            ...
            if (f3 < 2.0F)
              if (i11 < this.mItems.size())
              {
                ...
                float f4 = 2.0F + getPaddingRight() / getClientWidth();
                i12 = 1 + this.mCurItem;
                if (i12 >= m)
                  break label965;
                if ((f3 < f4) || (i12 <= n))
          ...
          while (true)
          {
            ...
            localObject2 = null;
            break label667;
            label822: localItemInfo11 = null;
            break label786;
            label828: if ((localObject2 != null) && (i12 == ((ViewPager.ItemInfo)localObject2).position))
            {
            ...
            i11++;
            float f5 = f3 + localItemInfo8.widthFactor;
            if (i11 < this.mItems.size());
            ...
            label965: calculatePageOffsets(localItemInfo3, i9, localItemInfo1);
