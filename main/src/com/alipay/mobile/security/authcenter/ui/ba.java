  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    try
    {
      TaobaoBindingAlipayUserActivity.dexopt(this.a).getMicroApplicationContext().startApp(TaobaoBindingAlipayUserActivity.getBundle(this.a).getAppId(), "20000009", null);
      return;
    }
