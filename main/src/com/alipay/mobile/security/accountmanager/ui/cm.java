  ...
  implements DialogInterface.OnCancelListener
{
  ...
  public final void onCancel(DialogInterface paramDialogInterface)
  {
    if ((ModifyLoginPwdActivity.b(this.a) != null) && (ModifyLoginPwdActivity.b(this.a).isAlive()))
    {
      ...
      ModifyLoginPwdActivity.e(this.a).getMicroApplicationContext().finishApp(ModifyLoginPwdActivity.c(this.a).getAppId(), ModifyLoginPwdActivity.d(this.a).getAppId(), null);
    }
    do
    {
      return;
