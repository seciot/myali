  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    SecurityAccountQrCodeActivity.getBundleByComponentName(this.a).getMicroApplicationContext().startActivityForResult(SecurityAccountQrCodeActivity.dexopt(this.a), localIntent, 4370);
  }
}
