...
public class a
{
  ...
  private d h;
  private HashMap<String, com.alipay.mobile.discoverywidget.ZResources.a> i;
  ...
  private void a()
  {
    ...
    this.g = new com.alipay.mobile.discoverywidget.ZResources.a.a(this.b);
  ...
  private HashMap<String, com.alipay.mobile.discoverywidget.ZResources.a> b()
  {
    try
    {
  ...
  public final void a(HomePageWidgetReq paramHomePageWidgetReq)
  {
    ...
    while (true)
    {
      ...
      if (localHashMap != null)
      {
        ...
        localIndexWidgetResult = null;
        if (localObject != null)
          localIndexWidgetResult = ((com.alipay.mobile.discoverywidget.ZResources.a)this.i.get(this.e)).getInstance();
      }
    }
  }
  ...
  protected void a(IndexWidgetResult paramIndexWidgetResult)
  {
    ...
    if (paramIndexWidgetResult.success)
    {
      ...
      this.i = this.h.b();
      com.alipay.mobile.discoverywidget.ZResources.a locala = (com.alipay.mobile.discoverywidget.ZResources.a)this.i.get(this.e);
      if (locala == null)
        locala = new com.alipay.mobile.discoverywidget.ZResources.a();
