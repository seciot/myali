...
public class VoucherCurrentListActivity extends AlipassListActivity
{
  ...
  protected final void a(AdapterView<?> paramAdapterView, View paramView, int paramInt, long paramLong)
  {
    ...
    if ((localObject != null) && ((localObject instanceof BaseAlipassInfoItem.AlipassInfoItem)))
    {
      ...
      AlipayLogAgent.writeLog(localAlipayApplication, localBehaviourIdEnum, "", "", "20000030", "", "couponDetails", "myCouponList", "seeCoupon", "", "", "", arrayOfString);
    }
  }
  ...
  protected final void a(a parama)
  {
    if ((parama != null) && (parama.e != null) && ((parama.e instanceof RpcException)) && (!parama.d) && (((RpcException)parama.e).getCode() == 2))
      getBundle(R.string.alipass_voucher_nonetwork_toast);
  }
  ...
  protected final View b()
  {
    if (this.g == null)
    {
      ...
      localAPButton.setOnClickListener(new fj(this));
      localAPButton.setText(getResources().getString(R.string.alipass_goto_voucher_web));
    }
    return this.g;
  }
 ...
 * Qualified Name:     com.alipay.mobile.alipassapp.ui.VoucherCurrentListActivity
