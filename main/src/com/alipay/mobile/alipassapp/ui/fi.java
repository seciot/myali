  ...
  implements View.OnClickListener
{
  ...
  public final void onClick(View paramView)
  {
    ...
    ((AlipassAppEntryDistributeService)TravelUserGuideActivity.a(this.a).getMicroApplicationContext().getExtServiceByInterface(AlipassAppEntryDistributeService.class.getName())).distributeApp("", "20000021", ((AlipassApp)TravelUserGuideActivity.b(this.a)).getAppBundle(), TravelUserGuideActivity.c(this.a).getMicroApplicationContext());
