  ...
  implements AuthorizeCallback
{
  ...
  {
    new StringBuilder("授权失败，appId=").append(an.a(this.a)).toString();
  }

  public final void onAuthSuccess(String paramString1, String paramString2)
  {
    new StringBuilder("应用授权成功，appId=").append(an.a(this.a)).append("，authCode=").append(paramString2).toString();
  ...
  {
    new StringBuilder("应用不需要授权，appId=").append(an.a(this.a)).toString();
    an.c(this.a);
  }

  public final void onUserCancel()
  {
    new StringBuilder("用户取消授权，appId=").append(an.a(this.a)).toString();
  }
}
