  ...
  implements TaobaoBindingCallback
{
  ...
  public final void quickBindingSuccess(MobileSecurityResult paramMobileSecurityResult)
  {
    ...
    MobileRechargeActivity.v(this.a, new RechargeHistoryInfo(MobileRechargeActivity.removeBundle(this.a), MobileRechargeActivity.f(this.a), this.a.d.getText().toString(), localEcardVOWrapper.a()));
    this.a.v(MobileRechargeActivity.removeBundle(this.a), localEcardVOWrapper);
  }
}
