  ...
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    Cursor localCursor = localContentResolver.query(localUri, arrayOfString, "bucket_id = ?", MultiPictureSelectorActivity.a(String.valueOf(MultiPictureSelectorActivity.a(this.a))), "datetaken DESC");
    if (localCursor != null)
    {
