  ...
  implements View.OnClickListener, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener
{
  ...
  private a h;
  private List<com.alipay.mobile.about.ui.DexUtil.b> i = new ArrayList();
  ...
  {
    com.alipay.mobile.about.ui.DexUtil.b localb = (com.alipay.mobile.about.ui.DexUtil.b)this.i.get(paramInt);
    if (localb.stop())
    {
      a(paramView);
