  ...
  implements BusinessJumpable
{
  ...
  public final void a()
  {
    ...
    if (this.a != null)
    {
      ...
      List localList = CardbinManager.getInstance(BankCardInfoFragment.getBundle(this.b)).queryCarbin(this.a.getInstance());
    ...
    try
    {
      BankCardInfoFragment.dexopt(this.b).startApp("20000071", "09999988", localBundle);
      return;
    }
