...
class CharArrayBuffers
{
  ...
  static int a(CharArrayBuffer paramCharArrayBuffer)
  {
  ...
  static boolean a(CharArrayBuffer paramCharArrayBuffer, int paramInt, String paramString)
  {
    int i = paramCharArrayBuffer.length();
    char[] arrayOfChar = paramCharArrayBuffer.buffer();
 ...
 * Qualified Name:     com.alipay.mobile.command.rpc.http.CharArrayBuffers
