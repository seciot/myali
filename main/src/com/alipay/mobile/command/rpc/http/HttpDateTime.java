...
public final class HttpDateTime
{
  ...
  public static long parse(String paramString)
  {
    ...
    while (true)
    {
      ...
      localTime.set(((HttpDateTime.TimeOfDay)localObject).c, ((HttpDateTime.TimeOfDay)localObject).b, ((HttpDateTime.TimeOfDay)localObject).a, i, j, m);
 ...
 * Qualified Name:     com.alipay.mobile.command.rpc.http.HttpDateTime
