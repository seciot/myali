...
public class BaseFragmentActivityShell extends FragmentActivity {
	static final String TAG = BaseFragmentActivityShell.class.getSimpleName();
	...
	protected void onActivityResult(int paramInt1, int paramInt2,
		...
		MiscUtils.callActivityOnMethod(this.targetActivity, "onActivityResult",
	...
	public void onAttachFragment(Fragment paramFragment) {
		if (this.targetActivity != null)
			((FragmentActivity) this.targetActivity)
	...
	protected void onChildTitleChanged(Activity paramActivity,
		...
		MiscUtils.callActivityOnMethod(this.targetActivity,
				"onChildTitleChanged", arrayOfClass, arrayOfObject);
	}
	...
	public void onCreateContextMenu(ContextMenu paramContextMenu,
		...
		if (this.targetActivity != null)
			this.targetActivity.onCreateContextMenu(paramContextMenu,
	...
	protected Dialog onCreateDialog(int paramInt) {
		...
		return (Dialog) MiscUtils.callActivityOnMethod(this.targetActivity,
				"onCreateDialog", arrayOfClass, arrayOfObject);
	}
	...
	public boolean onCreateThumbnail(Bitmap paramBitmap, Canvas paramCanvas) {
		if (this.targetActivity != null)
			return this.targetActivity.onCreateThumbnail(paramBitmap,
					paramCanvas);
	...
	public View onCreateView(String paramString, Context paramContext,
		...
		if (this.targetActivity != null)
			return this.targetActivity.onCreateView(paramString, paramContext,
					paramAttributeSet);
	...
	protected void onDestroy() {
		super.onDestroy();
		MiscUtils.callActivityOnMethod(this.targetActivity, "onDestroy", null,
				null);
	}
	...
	public boolean onKeyMultiple(int paramInt1, int paramInt2,
		...
		if (this.targetActivity != null)
			return this.targetActivity.onKeyMultiple(paramInt1, paramInt2,
					paramKeyEvent);
		return false;
	}
	...
	public boolean onMenuItemSelected(int paramInt, MenuItem paramMenuItem) {
		if (this.targetActivity != null)
			return this.targetActivity.onMenuItemSelected(paramInt,
					paramMenuItem);
	...
	protected void onNewIntent(Intent paramIntent) {
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnNewIntent(this.targetActivity, paramIntent);
	}
	...
	protected void onPause() {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnPause(this.targetActivity);
	}
	...
	protected void onPostCreate(Bundle paramBundle) {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnPostCreate(this.targetActivity, paramBundle);
	}

	protected void onPostResume() {
		super.onPostResume();
		MiscUtils.callActivityOnMethod(this.targetActivity, "onPostResume",
				null, null);
	}
	...
	protected void onPrepareDialog(int paramInt, Dialog paramDialog) {
		...
		MiscUtils.callActivityOnMethod(this.targetActivity, "onPrepareDialog",
				arrayOfClass, arrayOfObject);
	}
	...
	public boolean onPreparePanel(int paramInt, View paramView, Menu paramMenu) {
		if (this.targetActivity != null)
			return this.targetActivity.onPreparePanel(paramInt, paramView,
					paramMenu);
	...
	protected void onRestart() {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnRestart(this.targetActivity);
	}
	...
	protected void onRestoreInstanceState(Bundle paramBundle) {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnRestoreInstanceState(this.targetActivity,
							paramBundle);
	}
	...
	protected void onResume() {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnResume(this.targetActivity);
	}

	protected void onResumeFragments() {
		MiscUtils.callActivityOnMethod(this.targetActivity,
				"onResumeFragments", null, null);
	}

	public Object onRetainCustomNonConfigurationInstance() {
		if (this.targetActivity != null)
			return ((FragmentActivity) this.targetActivity)
	...
	protected void onSaveInstanceState(Bundle paramBundle) {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnSaveInstanceState(this.targetActivity,
							paramBundle);
	}
	...
	protected void onStart() {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnStart(this.targetActivity);
	}
	...
	protected void onStop() {
		...
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnStop(this.targetActivity);
	}
	...
	protected void onTitleChanged(CharSequence paramCharSequence, int paramInt) {
		...
		MiscUtils.callActivityOnMethod(this.targetActivity, "onTitleChanged",
				arrayOfClass, arrayOfObject);
	}
	...
	protected void onUserLeaveHint() {
		if (this.targetActivity != null)
			this.defaultEngine.getInstrumentation(this.targetActivity)
					.callActivityOnUserLeaving(this.targetActivity);
	}
