...
{
  private APPinnedHeaderListView.PinnedHeaderAdapter a;
  private View b;
  private boolean c;
  private int d;
  private int e;

  public APPinnedHeaderListView(Context paramContext)
  {
    super(paramContext);
  }

  public APPinnedHeaderListView(Context paramContext, AttributeSet paramAttributeSet)
  {
    super(paramContext, paramAttributeSet);
  }

  public APPinnedHeaderListView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
  ...
  public void setAdapter(ListAdapter paramListAdapter)
  {
    ...
    this.a = ((APPinnedHeaderListView.PinnedHeaderAdapter)paramListAdapter);
  }
 ...
 * Qualified Name:     com.alipay.mobile.commonui.widget.APPinnedHeaderListView
