...
public final class Headers
{
  ...
  private void a(CharArrayBuffer paramCharArrayBuffer, int paramInt)
  {
    if (CharArrayBuffers.containsIgnoreCaseTrimmed(paramCharArrayBuffer, paramInt, "Close"))
      this.c = 1;
    while (!CharArrayBuffers.containsIgnoreCaseTrimmed(paramCharArrayBuffer, paramInt, "Keep-Alive"))
      return;
    this.c = 2;
  }
 ...
 * Qualified Name:     com.alipay.mobile.common.transport.http.legacy.Headers
