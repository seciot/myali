...
public class PinYinAndHanziUtils
{
  ...
  public static List<String> getFullPY(String paramString)
  {
    ...
    if (i < arrayOfChar.length)
    {
      ...
      {
        arrayOfString = PinyinHelper.toHanyuPinyinStringArray(c);
      ...
      while (true)
      {
        i++;
        break;
        label74: if (arrayOfString[0] != null)
 ...
 * Qualified Name:     com.alipay.mobile.common.ui.contacts.util.PinYinAndHanziUtils
