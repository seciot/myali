...
public class ChineseToPy
{
  ...
  public static String getFullPy(String paramString)
  {
    ...
    for (int i = 0; ; i++)
    {
      if (i < g_hz.length)
      {
        String str2 = g_hz[i][0];
        if (g_hz[i][1].indexOf(paramString) != -1)
  ...
  public static String getSinglePy(String paramString)
  {
    String str1 = "";
    int i = 0;
    if (i < g_hz.length)
    {
      String str2 = g_hz[i][0];
      if (g_hz[i][1].indexOf(paramString) != -1)
        str1 = str2.toUpperCase().substring(0, 1);
    }
    else
    {
      if ((!"".equals(str1)) || (!paramString.matches("[a-zA-Z]+.*")))
        break label89;
      str1 = paramString.substring(0, 1).toUpperCase();
    }
    label89: 
    while ((!"".equals(str1)) || (!paramString.matches("[^a-zA-Z]+.*")))
    {
      return str1;
      str1 = "";
      i++;
  ...
  public String getStringFirstPY(String paramString)
  {
    Object localObject1 = "";
    ...
    while (true)
    {
      try
      {
        String str1 = getSinglePy(new String(arrayOfByte2, "gb2312"));
  ...
  public String getStringFullPY(String paramString)
  {
    Object localObject1 = "";
    byte[] arrayOfByte1 = paramString.getBytes();
    int i = 0;
    ...
    while (true)
    {
      try
      {
        String str1 = getFullPy(new String(arrayOfByte2, "gb2312"));
        String str2 = (String)localObject1 + str1;
        localObject1 = str2;
        int n = i + 1;
        localObject2 = localObject1;
 ...
 * Qualified Name:     com.alipay.mobile.common.utils.ChineseToPy
