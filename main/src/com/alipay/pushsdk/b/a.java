...
public class a extends com.alipay.pushsdk.BundlesManager.AppBundle.BundlesManagerImpl
{
  ...
  private static final String g = com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.getBundle(AppBundle.class);
  public int a = 0;
  Context d;
  ...
  public final String getBundle(String paramString)
  {
    ...
    try
    {
      ...
      com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(3, "HttpClient", "Request" + paramString);
      com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(3, "HttpClient", "Dest url:  " + localURL.toString());
      ...
      com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(3, g, "Response " + str.toString());
      return str;
    }
