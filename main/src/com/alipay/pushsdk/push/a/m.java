...
{
  private static final String m = com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.getBundle(m.class);
  protected Socket i;
  String j = null;
  j k;
  ...
  {
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(4, m, "sendPacket()... isConnected=" + getInstance());
    try
    {
      if (!getInstance())
    ...
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(5, m, "sendPacket()... writer=" + this.f.hashCode() + ", reader=" + this.e.hashCode());
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(3, m, "sendPacket()... packet.id=" + parama.getInstance());
  ...
  {
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(4, m, "setConnected()...isConnected=true");
    this.o = true;
  }
  ...
  {
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(3, m, "disconnect()... called!");
    ZLog.a(ZLog.v, ZLog.z, System.currentTimeMillis(), ZLog.E, 0L + System.currentTimeMillis(), "PushConnection_disconnect");
    if ((this.l == null) || (this.k == null))
      return;
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(2, m, "shutdown() called...");
    this.o = false;
    this.q = 0;
    g();
    if (this.l != null)
      ...
      try
      {
        while (true)
        {
          ...
          try
          {
            ...
            {
              this.i.close();
              label151: com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(3, m, "shutdown()... Done!");
              this.k.getInitLevel();
              this.k = null;
              this.l.getInitLevel();
              this.l = null;
              com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(3, m, "disconnect()... done!");
              return;
  ...
  {
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.FileUtil.e(4, m, "resetConnection()...");
    if (this.r != null)
      g();
    if (this.k != null);
    try
