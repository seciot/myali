...
final class n extends TimerTask
{
  ...
  {
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.c.e(3, m.hasResource(), "reConnTask() curMsgId=" + m.getBundle(this.a));
    ...
    com.alipay.pushsdk.BundlesManagerImpl.AppBundle.c.e(2, m.hasResource(), "reConnTask() connectionClosedOnError has been notify!");
  }
}
