...
public class e extends c
{
  ...
  private String[] d()
  {
    ...
    if (localFile.isDirectory())
    {
      ...
      if (arrayOfString != null)
      {
        ...
        com.alipay.pushsdk.c.a.c.a(3, a, "getMsgList() " + arrayOfString.length + " fileList=" + h.a(arrayOfString));
      }
  ...
  public final boolean a(NotifierInfo paramNotifierInfo)
  {
    ...
    com.alipay.pushsdk.c.a.c.a(3, a, "isContainMsg() ret=" + bool);
    return bool;
  }
  ...
  {
    String[] arrayOfString = d();
    com.alipay.pushsdk.c.a.c.a(4, a, "saveMsgRecord() msg:" + paramNotifierInfo.a());
    if ((arrayOfString != null) && (arrayOfString.length >= 50) && (!new File(c(), arrayOfString[0]).delete()))
      com.alipay.pushsdk.c.a.c.a(2, a, "saveMsgRecord() fail to delete file:" + arrayOfString[0]);
    String str1 = c();
    b localb = paramNotifierInfo.g();
    try
    {
      String str2 = localb.d() + "_" + localb.c();
      com.alipay.pushsdk.c.a.c.a(4, a, "saveMsgInfo() newPerMsgName:" + str2);
