  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    try
    {
      SecurityExaminationActivity.v(this.a, (SchemeService)SecurityExaminationActivity.d(this.a).getMicroApplicationContext().findServiceByInterface(SchemeService.class.getName()));
