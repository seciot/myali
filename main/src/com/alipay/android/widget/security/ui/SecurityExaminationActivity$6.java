  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    try
    {
      SecurityExaminationActivity.v(this.a, (SchemeService)SecurityExaminationActivity.i(this.a).getMicroApplicationContext().findServiceByInterface(SchemeService.class.getName()));
      ...
      {
        this.a.dexopt("com.alipay.mobile.android.main.avatar.action.changed");
