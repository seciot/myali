  ...
  implements View.OnClickListener
{
  ...
  public void onClick(View paramView)
  {
    try
    {
      SecurityExaminationActivity.v(this.a, (SchemeService)SecurityExaminationActivity.n(this.a).getMicroApplicationContext().findServiceByInterface(SchemeService.class.getName()));
