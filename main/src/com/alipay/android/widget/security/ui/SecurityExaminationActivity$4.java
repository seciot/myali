  ...
  implements View.OnClickListener
{
  ...
  {
    SecurityExaminationActivity.a(this.a, (SchemeService)SecurityExaminationActivity.a(this.a).getMicroApplicationContext().findServiceByInterface(SchemeService.class.getName()));
    ...
    ((BindPhoneService)SecurityExaminationActivity.c(this.a).getMicroApplicationContext().getExtServiceByInterface(BindPhoneService.class.getName())).bindPhone(this.a);
  }
}
