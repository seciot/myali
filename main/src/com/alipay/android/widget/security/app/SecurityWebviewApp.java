...
public class SecurityWebviewApp extends ActivityApplication
{
  ...
  protected void onStart()
  {
    ...
    localIntent.setClass(getMicroApplicationContext().getApplicationContext(), SecurityWebviewActivity_.class);
 ...
 * Qualified Name:     com.alipay.android.widget.security.app.SecurityWebviewApp
