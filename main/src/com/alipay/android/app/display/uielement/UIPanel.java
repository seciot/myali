...
public class UIPanel extends r
{
  ...
  {
    int i = -2;
    if ((!TextUtils.isEmpty(paramString1)) && (ElementDimension.a.getInstance().equals(paramString1)));
    for (int j = -1; ; j = i)
    {
      if ((!TextUtils.isEmpty(paramString2)) && (ElementDimension.a.getInstance().equals(paramString2)))
        i = -1;
