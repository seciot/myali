...
public class SetNoPasswordState
  implements IRequestOperator
{
  ...
  public final void a(IRequest paramIRequest, RequestContainer paramRequestContainer)
  {
    ...
    try
    {
      ...
      localJSONObject2.put("type", "nopwd");
    }
    catch (JSONException localJSONException1)
    {
      try
      {
        while (true)
        {
          ...
          localJSONObject1.put("nopwd", paramRequestContainer.j);
          localJSONObject1.put("nopwdValue", paramRequestContainer.f);
          ...
          if (this.a != null)
          {
            ...
            this.a.a(localRequestEnvelope.a(), 2, localInteractionData);
          }
          return;
 ...
 * Qualified Name:     com.alipay.android.setting.operator.SetNoPasswordState
