...
public class GetMiniCashierChannel
      ...
      try
      {
        while (true)
        {
          ...
          if (this.a != null)
          {
            ...
            this.a.a(localRequestEnvelope.a(), 4, localInteractionData);
          }
          return;
 ...
 * Qualified Name:     com.alipay.android.setting.operator.GetMiniCashierChannel
