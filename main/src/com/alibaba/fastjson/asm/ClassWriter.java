...
public class ClassWriter
{
  ...
  public byte[] toByteArray()
  {
    ...
    FieldWriter localFieldWriter1 = this.firstField;
    int i3;
    for (int j = 0; localFieldWriter1 != null; j = i3)
    {
      i3 = j + 1;
      i += localFieldWriter1.getSize();
      localFieldWriter1 = localFieldWriter1.next;
    }
    MethodWriter localMethodWriter1 = this.firstMethod;
    int k = i;
    int i2;
    for (int m = 0; localMethodWriter1 != null; m = i2)
    {
      i2 = m + 1;
      k += localMethodWriter1.getSize();
      localMethodWriter1 = localMethodWriter1.next;
    }
    ...
    int n = 0x60000 | (0x40000 & this.access) / 64;
  ...
  public void visit(int paramInt1, int paramInt2, String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    for (int j = 0; ; j = newClass(paramString2))
    {
      this.superName = j;
