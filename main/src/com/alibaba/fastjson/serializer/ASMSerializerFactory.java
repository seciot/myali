  ...
  implements Opcodes
{
  ...
  private void _apply(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
  ...
  private void _boolean(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
  ...
  private void _byte(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _char(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _decimal(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
  ...
  private void _double(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _enum(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    int i = 0;
    ...
    if (localJSONField != null)
    {
      ...
      int k = arrayOfSerializerFeature.length;
      j = 0;
      while (i < k)
      {
  ...
  private void _filters(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext, Label paramLabel)
  {
  ...
  private void _float(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _get(MethodVisitor paramMethodVisitor, ASMSerializerFactory.Context paramContext, FieldInfo paramFieldInfo)
  {
    ...
    paramMethodVisitor.visitVarInsn(25, paramContext.var("entity"));
    paramMethodVisitor.visitFieldInsn(180, ASMUtils.getType(paramFieldInfo.getDeclaringClass()), paramFieldInfo.getName(), ASMUtils.getDesc(paramFieldInfo.getFieldClass()));
  }

  private void _if_write_null(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Class localClass = paramFieldInfo.getFieldClass();
    Label localLabel1 = new Label();
    Label localLabel2 = new Label();
  ...
  private void _int(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _list(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    ...
    label1308: label1534: for (Class localClass = (Class)localObject; ; localClass = null)
    {
      Label localLabel1 = new Label();
      Label localLabel2 = new Label();
      Label localLabel3 = new Label();
      ...
      if (localObject == String.class)
      {
        ...
        paramMethodVisitor.visitLabel(localLabel1);
        return;
        localObject = ((java.lang.reflect.ParameterizedType)localType).getActualTypeArguments()[0];
        break;
      }
      paramMethodVisitor.visitVarInsn(25, paramContext.serializer());
      paramMethodVisitor.visitVarInsn(25, paramContext.var("list"));
  ...
  private void _long(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _nameApply(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext, Label paramLabel)
  {
    paramMethodVisitor.visitVarInsn(25, paramContext.serializer());
    paramMethodVisitor.visitVarInsn(25, paramContext.obj());
    paramMethodVisitor.visitVarInsn(25, paramContext.fieldName());
  ...
  private void _object(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _processKey(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Class localClass = paramFieldInfo.getFieldClass();
    paramMethodVisitor.visitVarInsn(25, paramContext.serializer());
    paramMethodVisitor.visitVarInsn(25, paramContext.obj());
  ...
  private void _processValue(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Class localClass = paramFieldInfo.getFieldClass();
    paramMethodVisitor.visitVarInsn(25, paramContext.serializer());
    paramMethodVisitor.visitVarInsn(25, paramContext.obj());
  ...
  private void _seperator(MethodVisitor paramMethodVisitor, ASMSerializerFactory.Context paramContext)
  {
    paramMethodVisitor.visitVarInsn(16, 44);
    paramMethodVisitor.visitVarInsn(54, paramContext.var("seperator"));
  }

  private void _short(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _string(Class<?> paramClass, MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel1 = new Label();
    _nameApply(paramMethodVisitor, paramFieldInfo, paramContext, localLabel1);
    _get(paramMethodVisitor, paramContext, paramFieldInfo);
  ...
  private void _writeObject(MethodVisitor paramMethodVisitor, FieldInfo paramFieldInfo, ASMSerializerFactory.Context paramContext, Label paramLabel)
  {
    JSONField localJSONField = (JSONField)paramFieldInfo.getAnnotation(JSONField.class);
    if (localJSONField != null)
    {
  ...
  private void generateWriteMethod(Class<?> paramClass, MethodVisitor paramMethodVisitor, List<FieldInfo> paramList, ASMSerializerFactory.Context paramContext)
  {
    Label localLabel1 = new Label();
    ...
    paramMethodVisitor.visitJumpInsn(153, localLabel7);
    paramMethodVisitor.visitVarInsn(25, paramContext.paramFieldType());
    paramMethodVisitor.visitVarInsn(25, paramContext.obj());
    paramMethodVisitor.visitMethodInsn(182, ASMUtils.getType(Object.class), "getClass", "()Ljava/lang/Class;");
    paramMethodVisitor.visitJumpInsn(165, localLabel7);
    paramMethodVisitor.visitLabel(localLabel8);
    paramMethodVisitor.visitVarInsn(25, paramContext.var("out"));
    paramMethodVisitor.visitLdcInsn("{\"@type\":\"" + paramClass.getName() + "\"");
    paramMethodVisitor.visitMethodInsn(182, ASMUtils.getType(SerializeWriter.class), "write", "(Ljava/lang/String;)V");
    paramMethodVisitor.visitVarInsn(16, 44);
    ...
    paramMethodVisitor.visitLdcInsn("{}");
    paramMethodVisitor.visitMethodInsn(182, ASMUtils.getType(SerializeWriter.class), "write", "(Ljava/lang/String;)V");
    paramMethodVisitor.visitJumpInsn(167, localLabel11);
  ...
  private void initNature(Class<?> paramClass, MethodVisitor paramMethodVisitor, ASMSerializerFactory.Context paramContext)
  {
    paramMethodVisitor.visitVarInsn(25, 0);
  ...
  {
    return createJavaBeanSerializer(paramClass, null);
  }
  ...
  public ObjectSerializer createJavaBeanSerializer(Class<?> paramClass, Map<String, String> paramMap)
  {
    ...
    ASMSerializerFactory.Context localContext1 = new ASMSerializerFactory.Context(str);
    ...
    ASMSerializerFactory.Context localContext2 = new ASMSerializerFactory.Context(str);
