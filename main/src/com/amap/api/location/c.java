...
public class c
{
  ...
  private c(Context paramContext, LocationManager paramLocationManager, IOUtil.a parama)
  {
  ...
  static c a(Context paramContext, LocationManager paramLocationManager, IOUtil.a parama)
  {
    if (b == null)
